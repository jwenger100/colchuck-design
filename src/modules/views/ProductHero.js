...
const backgroundImage =
  'https://upload.wikimedia.org/wikipedia/commons/a/a8/Aasgard_Pass.jpg';
  ...
  return (
    <ProductHeroLayout backgroundClassName={classes.background}>
      ...
      <Typography color="inherit" align="center" variant="h5" className={classes.h5}>
        A Seattle based web design company with the mission of building cost effective websites to suit your business needs.
